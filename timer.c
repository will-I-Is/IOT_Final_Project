...
bool startOneshotTimer(_callback callback, void *data, uint32_t seconds)
{
    uint8_t i = 0;
    bool found = false;
...
bool startPeriodicTimer(_callback callback, void *data, uint32_t seconds)
{
    uint8_t i = 0;
    bool found = false;
    while (i < NUM_TIMERS && !found)
